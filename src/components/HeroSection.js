...
function HeroSection() {
 ...
 <div className="flex flex-col items-center sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 sm:px-10 md:px-0">
  <button
    onClick={() => {
    ...
    className="
      ...
      bg-gradient-to-r from-[#33a4b8] to-[#097f94] 
      text-black font-roboto py-3 px-8 rounded-lg shadow-md 
      hover:from-[#00d9ff] hover:to-[#33a4b8] 
